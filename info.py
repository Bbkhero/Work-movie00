...
BOT_TOKEN = environ.get('BOT_TOKEN', '7594693248:AAHubu-qceibM25E03dicbwoxvvppEUWhYA')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gdsxds6uhg:IJ1VdXwSbLcnrYLr@cluster0.i9o4x.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002252323257'))
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/NZSRJfK/images.png')
START_IMG = environ.get('START_IMG', 'https://i.ibb.co/NZSRJfK/images.png')
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002086504362')
